...
Utilizando los métodos adecuados de numpy  para calcular el promedio de la población de todas estas ciudades y redondea el resultado,
el cual debes almacenar en una variable llamada: promedio_poblacion
'''
